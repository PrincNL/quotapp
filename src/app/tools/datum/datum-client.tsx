...
import { Calendar, RotateCcw, Briefcase, Share2 } from "lucide-react";
...
export function DatumCalculatorClient() {
  ...
  const resultText = resultaat
    ? `${resultaat.dagen} dagen tussen ${datum1} en ${datum2}`
    : "";
        ...
        <div>
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-600 text-white shadow-lg">
                <Calendar className="w-8 h-8" />
              </div>
              <FavoriteButton toolName="Datum" variant="icon" />
            </div>
          ...
          <div className="mt-8 flex justify-center">
            <FeedbackForm toolName="Datum Calculator" />
          </div>
        </div>

        <StickyAd slot="sidebar-ad-datum" />
      </div>
    </div>
  );
}
